...
class Colors extends React.Component {
    ...
    render() {
        ...
        //triplecolors
        if (red && blue && yellow) { clr = "white"; cvalue = "White" }
        //doublecolors
        else if (red && blue) { clr = "violet"; cvalue = "Purple" }
        else if (red && yellow) { clr = "orange"; cvalue = "Orange" }
        else if (yellow && blue) { clr = "green"; cvalue = "Green" }
        //singlecolors
        else if (red) { clr = "red"; cvalue = "Red" }
        else if (blue) { clr = "blue"; cvalue = "Blue" }
        else if (yellow) { clr = "yellow"; cvalue = "Yellow" }
        else { clr = "black"; cvalue = "Black" }
